...
<div class="uk-vertical-align uk-text-center uk-height-1-1">
    <div class="uk-vertical-align-middle" style="width: 450px;">
        <form class="uk-panel uk-panel-box uk-form" action="main.jsp" method="post" onsubmit="return new_build_user()">
            <h2>新建用户</h2>
            ...
            <div class="uk-form-row">
                <button class="uk-width-1-1 uk-button uk-button-primary uk-button-large" type="submit">新建</button>
                <span id="checkFormResult" style="color: red"></span>
            </div>
            <div class="uk-form-row uk-text-small">
                <a class="uk-float-right uk-link uk-link-muted" href="main.jsp">返回主页面</a>
            </div>
        </form>
    </div>
</div>
